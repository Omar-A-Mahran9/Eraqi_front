        ...
        <footer class="footer container">
            <v-row>
                ...
                <v-col cols="12" md="3">
                    ...
                    >
                        <h1
                            class="text-main font-bold pb-3"
                    ...
                    >
                        ...
                        <li>
                            <nuxt-link
                                ...
                                class="-mx-3 block rounded-lg px-3 py-1 text-base font-semibold leading-7 text-white"
                                >{{
                                    $t("for travel and tourism agencies")
                                }}</nuxt-link
                            >
                        </li>
                        <li>
                ...
                <v-col cols="12" md="3">
                    ...
                    >
                        <h1
                            class="text-main font-bold pb-6"
                            style="font-size: 20px"
                        >
                            {{ $t("Contact with us") }}
                        </h1>
            ...
            <div
                class="d-flex flex-col justify-center align-center mb-13 mt-10"
            >
                <hr
                    width="100%"
                    class="mb-5"
            ...
            <div class="mt-9 md:mt-0">
                <p
                    ...
                    v-html="footer.copyright[locale]"
                ></p>
