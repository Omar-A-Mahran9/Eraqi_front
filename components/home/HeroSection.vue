<template>
    <v-carousel :show-arrows="showArrows" hide-delimiters style="height: 655px">
        <v-carousel-item
            ...
            :key="index"
            :src="`~/assets/img/index/${image.src}`"
            cover
        >
            <div class="relative w-full h-full">
                ...
                <div
                    class="flex flex-col gap-5 justify-center h-full w-full container"
                >
                    <div>
                        <p
                            ...
                            <div
                                :style="{
                                    ...
                                    borderTopRightRadius:
                                        locale === 'en' ? '25px' : '0', // Add border radius for right side in RTL
                                }"
                            >
                                <v-tab
                                ...
                                >
                                    <div
                                        class="d-flex align-center gap-2 align-center"
                                    >
                                        <span v-html="tabItem.icon"></span>
                                        <span class="mt-1">{{
                                            tabItem.title[locale]
                                        }}</span>

                                        <v-tooltip
                                            v-if="tabItem.hint.show"
                                            v-model="
                                                tooltipVisibility[tabIndex]
                                            "
                                            location="top"
                                ...
                                <v-tabs-window v-model="tab">
                                    ...
                                    <v-tabs-window-item value="two">
                                        <v-form v-model="valid">
                                            ...
                                            <div>
                                                <p
                                                    class="text-lg font-light text-gray-400 mb-5"
                                                >
                                                    {{
                                                        $t(
                                                            "Book with us fully package"
                                                        )
                                                    }}
                                                </p>
...
const images = [
    {
        ...
        src: "hero.png", // Just the image filename
    },
